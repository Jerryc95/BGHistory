...
function Handler:updateDB(battleground, winner)
    ...
    elseif (battleground == "Battle for Wintergrasp") then
        ...
        elseif (winner == 1)  then
            BGHistoryAccountDB.BattleForWintergrasp.Alliance = BGHistoryAccountDB.BattleForWintergrasp.Alliance + 1
            BGHistoryCharDB.BattleForWintergrasp.Alliance = BGHistoryCharDB.BattleForWintergrasp.Alliance + 1
        end
